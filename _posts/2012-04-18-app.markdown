...
* Windows: לחצי על Start וחפשי את *Command Prompt*, אחר כך, אחר כך לחצי על *Command Prompt with Ruby on Rails*.
...
* מדריך 2: [העלי את האפליקציה שלך לאינטרנט עם Heroku, מאת Terence Lee](/heroku)
