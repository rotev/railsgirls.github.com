...
## או איך מארגנים את ארוע Rails Girls הראשון

המטרה שלנו - לתת לנשים כלים להבין טכנולוגיה. הארועים של Rails Girls זוהי הזדמנות מצויינת להתנסות בפעם הראשונה בבנייה ופיתוח לאינטרנט.

Rails Girls הראשון נערך בסוף 2010 בהלסינקי, ובמקור תוכנן כארוע חד פעמי. מעולם לא חשבנו שנראה סניפים מקומיים כה רבים נפתחים מסביב לעולם! המדריך הבא נועד לעזור לך להתחיל.

אם הינך מעוניינת לארגן ארוע, ראשית מלאי את הטופס הבא [http://railsgirls.com/inyourcity](http://railsgirls.com/inyourcity) וחבר צוות שלנו יצור איתך קשר

בקישור הבא ניתן לראות את הארועים המתוכננים לעתיד [www.railsgirls.com](http://railsgirls.com).

ניתן להצטרף ל [פורום של המארגנים ב slack](https://rails-girls-slack.herokuapp.com/).

### The Basics
 
הארועים של Rails Girls אינם למטרות רווח. אנו לא גובים כסף מהמשתתפים, ולא משלמים למדריכים ומרצים. מהמשתתף לא נדרש ידע קודם בתכנות, ואין הגבלת גיל. כל מה שצריך - מחשב נייד וקצת סקרנות.

ארוע בן יומיים יכלול הרבה עבודה בקבוצות קטנות, והרצאות קצרות וממוקדות בנושאי תכנות, עיצוב ואינטרנט. ללא דיוני פנל, וללא הרצאות במה - אווירה מעשית ובלתי פורמלית. פחות אבסטרקציה ויותר מעורבות.

#### הפילוסופיה של Rails Girls

* הראו התלהבות, אישיות והחזיקו בראש את התמונה הגדולה. הסבירו, חזרו ותמיד תציגו את ההקשר הרחב לדבריכם.
* האינטרנט נבנה על ידי אנשים, וקצת חובבנות לא מזיקה הרבה. התמידו בהצגת הצד האנושי: עודדו את המדריכים לדבר על קהילות קוד פתוח, דמויות נערצות מעולם התכנות ושאיפות אישיות. 
* חוקי העתק-הדבק. תכנות בפני עצמו לא עומד במרכז - ללמוד סינית ביום אחד זו משימה בלתי אפשרית. כנ"ל לגבי שפת תכנות. נתמקד באוצר מילים וביטויים בסיסיים לכתיבת קוד. המטרה שנגיע לתוצר!
* זהו עולם של בנות! אך גם נשים, ואפילו בנים מוזמנים. שני המייסדים נולדו בעידן הספייס גירלז, ולא רואים במילה "בנות" התנשאות או חומד יתר. 
